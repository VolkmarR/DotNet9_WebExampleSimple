...
### Activate Static Files in the program.cs file

<details><summary>Activate the static file serving in the program.cs (before the app.MapGet code block).</summary>
...
<details><summary>Replace the content of the index.html file with the following code.</summary>
...
- Try if you can add questions and vote on them.